...
**Panduan instalasi feidlambda v0.3.x dapat dilihat di halaman [Penggunaan](/docs/penggunaan.qmd).**
...
- **Update v0.3.1 (2022-01-13)** 
  ...
  - Tambahan informasi limitasi pada fungsi `TEXT_SPLIT_VECTOR()` antara lain:
