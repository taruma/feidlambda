...
[<button type="button" class="btn btn-primary m-1">WORKSHEET FEIDMATH v0.1.0</button>](https://github.com/fiakoenjiniring/feidlambda/releases/download/v0.4.0/RELEASE_feidmath_v0_1_0.xlsx)
